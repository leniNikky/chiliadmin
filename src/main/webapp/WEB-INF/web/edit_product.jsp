...
<body>
 <div class="wrap">
  ...
  <form action="/formUpload_2" id="ajform" method="post">
  <input type="hidden" class="textBox length-long" name="goodsID" value="${goods.goodsID }"/>
  <table class="list-style">
  <tr>
    <td style="text-align:right;width:15%;">商品编号：</td>
    <td><input type="text" class="textBox length-long" name="goodsNo" value="${goods.goodsNo }"/></td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <td>
     ...
     <input type="hidden" name="goodsimg" value="${goods.goodsimg }" id="picInput">
   ...
   <tr>
    ...
    <td>
     ...
     <input type="hidden" name="pictext" value="${goods.pictext }" id="pic1Input">
   ...
   <tr>
    ...
    <td>
     ...
     <input type="hidden" name="gimg1" value="${goods.gimg1 }" id="pic2Input">
   ...
   <tr>
    ...
    <td>
     ...
     <input type="hidden" name="gimg2" value="${goods.gimg2 }" id="pic3Input">
   ...
   <tr>
    ...
    <td>
     ...
     <input type="hidden" name="gimg3" value="${goods.gimg3 }" id="pic4Input">
   ...
   <tr>
    ...
    <td><textarea class="textarea" name="goodsIntr" value="${goods.goodsIntr }"></textarea></td>
   </tr>
   <tr>
